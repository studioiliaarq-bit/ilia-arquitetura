    ...
    createProjects() {
      ...
      const projects = [
        ...
        },
        {
          ...
          description: '',
          dayAndNight: false,
          thumbnail: require('@/assets/apartamento/capa.webp'),
          imagesDay: [
            require('@/assets/apartamento/1.webp'),
            require('@/assets/apartamento/2.webp'),
            require('@/assets/apartamento/3.webp'),
            require('@/assets/apartamento/4.webp'),
            require('@/assets/apartamento/5.webp'),
            require('@/assets/apartamento/6.webp'),
            require('@/assets/apartamento/7.webp'),
            require('@/assets/apartamento/8.webp'),
