<template>
    ...
    <div id="container-links">
        ...
        <div class="mb-3">
          <a :href="tiktokLink()" target="_blank" class="mx-3">  
          ...
          <a :href="instagramLink()" target="_blank" class="mx-3">
          ...
          <a :href="whatsappLink()" target="_blank" class="mx-3">
  ...
  methods: {
    ...
    scrollToDown(duration = 1500) {
      ...
      const containerLinks = document.querySelector("#container-links");
        ...
        const end = containerLinks.offsetTop;
